...
\begin{tabular}{|c|l|c|c|l|c|c|}
	\hline
	Partic. & Role & Exp. & Gender & Industry & Project Model & Project Size\\
	\hline
...
We conducted 10 semi-structured interviews with software practitioners to allow for unanticipated information to be mentioned~\cite{seaman2008qualitative}.
...
\comment{***Analysis***}
\todo{write how survey analysis was done. Median, +- 2\% from middle is 50/50}
For each question...