...
\textit{Analysis:} Interviews were unitized into cards that each contain a single logically consistent statement. This standardized coding scheme was created by the first and second author, and improved to an acceptable point by measure of intercoder agreement~\cite{unitization}. The coding scheme dictated that lines must be consecutive and topically related to be grouped into a single card. Logically connected statements that were separated by other lines were considered to be separate cards, as a conservative measure to preserve context within each card.
...
We conducted a 50-question survey of software development practictioners in order to examine the themes and categories found in the interviews.
The survey was conducted online and anonymity was guaranteed in order to illicit honest responses from participants.
Questions were developed to confirm, extend, and broaden the results from the interviews.
We wanted to understand which factors impact developers the most when encountering and working to resolve merge conflicts.
...
The population of 226 survey respondents were overwhelmingly male (91.89\% overall), overwhelmingly have held the role of \textit{Software Engineer/Developer} (94.25\% overall, see Table~\ref{survey_roles}), median software development experience is 6-10 years (33.63\% overall), and median size of project that they work on is 2-5 developers (49.12\% overall).
...
\textit{Survey Analysis:} We evaluated the distribution of survey answers for each Likert scale question by analyzing across demographic categories. 
We used the mean score for each demographic to determine the positive, negative, or neutral response of the population. 
We consider the third option (on a 5-point Likert scale) to be neutral, and round scores in the range 2.50 to 3.50 to be equivalent to this neutral response.
