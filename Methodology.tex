...
This allows us to analyze both qualitative and quantitative data to get both an individual and a population-wide perspective of software practitioners.
...
We selected interview participants from top contributors to open-source projects, and from industry contacts using snowball sampling~\cite{goodman1961snowball}.
This allows us to 
...
Participants worked on a variety of software project sizes: 5 worked primarily on large projects, 3 on medium projects, and 2 on small projects. 
...
The Likert scale questions were written to measure the extent to which participants agreed with a particular answer choice (i.e. \textit{Not at all} to \textit{A great deal}). This means that lower mean and median values indicate less agreement with the statement in a particular question.
