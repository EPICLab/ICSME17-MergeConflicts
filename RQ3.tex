...
\todo{determine the average number of tools that survey respondents entered for X below}
...
Our participants indicated that they use \textbf{X} merge tools on average.
