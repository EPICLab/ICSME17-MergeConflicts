...
\subsubsection{\underline{Tool Usability}}
Having the right toolset allows a practitioner to efficiently work towards solutions, instead of losing time to tool inadequacies.
Usability is a major factor in determining whether a toolset will support a practitioner's workflow.
We found that practitioners see usability as the most desired improvement for current merge tools (I1).
