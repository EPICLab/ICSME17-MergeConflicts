...
Practitioners conveyed that they would like to see tools that share a common language in both terminology and presentation. 
...
The results of the survey are counterintuitive to our interview results, when we looked further, we found that a large number of participants \textbf{SEPARATED DISCONTINUING THE? toolset. 
but appears to indicate that practitioners abandon mistrusted tools before all trust is lost in them.}

\Subsubsection{Perceptions of Tool Effectiveness}
...
The size and number contained within each bubble represent the total number of respondents with a particular amount of software development experience that rated their toolset effectiveness at a particular level.
