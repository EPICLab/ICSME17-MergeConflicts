...
\subsubsection{\underline{Artifact-based Factors}}\label{artifact-based-factors}
...
\subsubsection{\underline{Knowledge-based Factors}}\label{knowledge-based-factors}
