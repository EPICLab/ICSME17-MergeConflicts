...
Program comprehension has been an important research focus, with an entire conference dedicated to it.
...
However, researchers should investigate the margin of error that is tolerated by practitioners, and in what contexts, before practitioners discontinue use of tools for conflict resolution.
