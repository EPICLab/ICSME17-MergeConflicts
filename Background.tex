...
%\todo{This isn't really "background". How weird would it be to call this section, "On Merge Conflicts" or something of that sort?}
\todo{This should just be nuked; if we want to add merge conflict definition, do it in Methodology}
