...
\todo{Clean-up bibliography section to remove unnecessary elements.}
\todo{Remove unused citations from Bibliography.bib file.}
...
This paper examines merge conflicts from the practitioner standpoint, seeking to understand the perceived difficulties and the processes of resolving them.
...
\vspace{3px}
\noindent\textbf{RQ1:} \textit{How do software practitioners approach merge conflicts?}\\
\noindent\textbf{RQ2:} \textit{What unmet needs impact the difficulty of a merge conflict resolution?}\\
\noindent\textbf{RQ3:} \textit{Do developer tools meet practitioner needs for merge conflicts?}
\vspace{3px}
...
We found that, during the resolution process, practitioners identified code understandability, their knowledge in the area of code conflict, and the available information about the conflicting code as key factors that impact the difficulty of resolving merge conflicts.
